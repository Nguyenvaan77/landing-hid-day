...
export default function LeGaiDetailSection() {
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(135deg, rgba(95,180,85,0.1) 0%, rgba(95,180,85,0.2) 100%)" }}
    >
      {/* Background Pattern */}
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative animate-fade-in-left visible">
            ...
            <div
              ...
              style={{ backgroundColor: "rgba(95,180,85,0.9)" }}
            ></div>
            <div
              ...
              style={{ backgroundColor: "rgba(95,180,85,0.4)" }}
            ></div>
          </div>
          ...
          <div className="space-y-6 animate-fade-in-right visible">
            <div className="space-y-4">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight" style={{ color: "#1d5f1d" }}>
                Lê gai
              </h2>

              <div className="space-y-3 text-lg" style={{ color: "#2f5f30" }}>
                <p>
                  <strong>Đặc điểm:</strong> Quả nhỏ tròn, màu nâu sậm khi khô, đường kính ~1,5–2 cm, vị chua thơm
                </p>
                <p>
                  <strong>Dinh dưỡng:</strong> Giàu vitamin C (gấp nhiều lần cam), polyphenol, flavonoid
                </p>
              </div>
            </div>
          </div>
